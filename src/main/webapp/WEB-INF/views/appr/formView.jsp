		...
		<div class="middle" >
			<div id="pdfDiv">
				...
				<table class="__se_tbl" 
					style="width: 700px; margin:auto; border-collapse: collapse !important; color: black; background: white; border: 1px solid black; font-size: 12px; font-family: 'SUIT'">
					<thead>
						<tr>
							<td
					...
					<tbody>
						...
						<tr>
							<td id="conText" colspan="3"
								style="padding: 5px; border: 1px solid black; height: 300px; text-align: left; color: rgb(0, 0, 0); font-size: 16px; 
