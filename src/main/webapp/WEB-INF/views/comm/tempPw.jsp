	        ...
	        <div class="container">
	          <div class="row justify-content-center">
	            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
	              ...
	              <div class="card mb-3" style="font-family: 'SUIT'">
	
	                <div class="card-body">
	
	                  <div class="pt-4 pb-2">
	                    <h5 class="card-title text-center pb-0 fs-4" style="font-family: 'SUIT'">임시 비밀번호 발급</h5>
	                    <div class="mb-4"></div>
	                  </div>
...
<!-- 	                        <span class="input-group-text" id="inputGroupPrepend">@</span> -->
	                    ...
	                    <script>
					        document.getElementById('emp_email').addEventListener('input', function() {
					            ...
					            var pattern = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
					            if(email != ""){
						            if (email.match(pattern)) { // 이메일 형식 맞음
						                document.getElementById('emailError').textContent = '이메일 형식에 해당합니다.';
						                document.getElementById('emailError').style.color = 'green';
						            } else { // 이메일 형식 아님
						                document.getElementById('emailError').textContent = '이메일 형식이 올바르지 않습니다.';
