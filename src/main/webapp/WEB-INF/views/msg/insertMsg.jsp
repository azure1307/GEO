...
<body>
	<%@ include file="../comm/sidebar.jsp" %>
 	<main id="main" class="main" style="background:#eef2fa;">
		...
		<div class="pagetitle">
			<h1 style="font-family: 'SUIT'">쪽지 작성</h1>
			<nav>
				<ol class="breadcrumb">
					<li class="breadcrumb-item" style="font-family: 'SUIT'">쪽지</li>
					<li class="breadcrumb-item active" style="font-family: 'SUIT'"><a href="./insertMsg.do">쪽지 작성</a></li>
				</ol>
			</nav>
		</div><!-- End Page Title -->
		...
		<section class="section">
	      <div class="row">
	        <div class="col-lg-12">
	          ...
	          <div class="card">
	            <div class="card-body">
	              <h5 class="card-title" style="font-family: 'SUIT'">쪽지 작성</h5>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-header">
									<h5 class="modal-title" style="font-family: 'SUIT'"><b>받는사람 선택</b></h5>
								</div>
